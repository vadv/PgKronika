...
fn activity_view() -> ViewSpec {
    ...
    let columns = vec![
        ...
        derived_column(
            "rss",
            ValueType::I64,
            "process.rmem_kb through unique same-snapshot PID candidate",
            &["activity", "process"],
            Some("kib"),
        ),
        derived_column(
            "threads",
            ValueType::U64,
            "process.num_threads through unique same-snapshot PID candidate",
            &["activity", "process"],
            Some("count"),
        ),
        derived_column(
        ...
        derived_column(
            "command",
            ValueType::Text,
            "process.cmdline through unique same-snapshot PID candidate",
            &["activity", "process"],
            None,
        ),
        raw_column(
...
fn processes_view() -> ViewSpec {
    let mut columns = vec![
        ...
        derived_column(
            "cpu_user",
            ValueType::F64,
            "positive_delta(utime) / (clock_ticks_per_sec * elapsed_seconds)",
            &["process", "instance"],
            Some("ratio"),
        ),
        derived_column(
            "cpu_system",
            ValueType::F64,
            "positive_delta(stime) / (clock_ticks_per_sec * elapsed_seconds)",
            &["process", "instance"],
            Some("ratio"),
        ),
        derived_column(
            "run_delay",
            ValueType::F64,
            "positive_delta(rundelay_ns) / (1e9 * elapsed_seconds)",
            &["process"],
            Some("ratio"),
        ),
        derived_column(
        ...
        derived_column(
            ...
            ValueType::F64,
            "positive_delta(nvcsw) / elapsed_seconds",
            &["process"],
            Some("per_second"),
        ),
        derived_column(
            ...
            ValueType::F64,
            "positive_delta(nivcsw) / elapsed_seconds",
            &["process"],
            Some("per_second"),
        ),
        derived_column(
            ...
            ValueType::F64,
            "positive_delta(minflt) / elapsed_seconds",
            &["process"],
            Some("per_second"),
        ),
        derived_column(
            ...
            ValueType::F64,
            "positive_delta(majflt) / elapsed_seconds",
            &["process"],
            Some("per_second"),
        ),
        derived_column(
            ...
            ValueType::F64,
            "positive_delta(syscr) / elapsed_seconds",
            &["process"],
            Some("per_second"),
        ),
        derived_column(
            ...
            ValueType::F64,
            "positive_delta(syscw) / elapsed_seconds",
            &["process"],
            Some("per_second"),
        ),
        derived_column(
            ...
            ValueType::F64,
            "positive_delta(rchar) / elapsed_seconds",
            &["process"],
            Some("bytes_per_second"),
        ),
        derived_column(
            ...
            ValueType::F64,
            "positive_delta(wchar) / elapsed_seconds",
            &["process"],
            Some("bytes_per_second"),
        ),
        derived_column(
