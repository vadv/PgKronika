...
| `KRONIKA_RETENTION` | — | Удержание дерева в пределах бюджета: байты (например `1073741824`), `auto` (умолчально 80% использованной доли раздела) или `auto:P` (например `auto:75`). Не задана — ротация отключена. |
