...
pub use codec::{
    ...
    pg_stat_archiver, pg_stat_database, pg_stat_io, pg_stat_progress_vacuum, pg_stat_user_indexes,
    pg_stat_user_tables, pg_stat_wal, replication_instance, reset_metadata,
};
