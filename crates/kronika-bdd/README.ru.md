...
- строка содержит метку времени, которую передал вызывающий код;
...
проверяет, что секция `1_006_001` декодируется ровно в одну строку снимка.
Временной диапазон сегмента должен совпадать с этой строкой.
