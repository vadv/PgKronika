...
| PostgreSQL logs | файловый доступ к stderr log path или sidecar shipping | `1_029_001` фиксирует `source_unavailable`/`unsupported_format`/`permission_denied`/`disabled`/`query_failed`; typed log rows отсутствуют |
