...
Первая реализованная область логов — bounded tailer для `stderr`, группировка
ошибок и явные строки деградации. Коллектор не пишет сырые строки лога в PGM:
все выходы агрегированы или типизированы, текстовые поля ограничены до
интернирования.
