...
`kronika-analytics::overview` пока предоставляет только типы, редукции,
health-оценку и oracle interface. PGM extraction, persistent overview index и
HTTP endpoints в reader/web ещё не подключены.
