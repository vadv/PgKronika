...
Существующие header magic и `format_version` — внутренний fail-fast
...
- feature flag, env toggle или runtime mode;
- offline compactor для опубликованных сегментов.
...
1. `kronika-format`
   ...
   - сменить внутреннюю пару magic/version как единый fail-fast
     идентификатор и принимать только её;
